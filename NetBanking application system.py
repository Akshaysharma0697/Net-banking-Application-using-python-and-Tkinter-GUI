...
"""FRONT END OF THE PROJECT NET BANKING SYSTEM
from tkinter import*
from PIL import ImageTk,Image
import tkinter.messagebox
...
def home():
    ...
    img = ImageTk.PhotoImage(Image.open('C:\\Users\\Akshay\\PycharmProjects\\Project1\\money.jpg'))
    Label(frame1, image=img, width='1366', height='768').place(x=0, y=0)
    Label(frame1, text=' Net Banking Application', bg='black',fg='white', font=('Yu Gothic', 40, 'bold')).place(x=410, y=0)
    Label(frame1, width='62', height='30',bg='grey',bd=8).place(x=500, y=170)
    Label(frame1, text='LOGIN',fg='white',bg='black', font=('Yu Gothic', 15, 'bold')).place(x=670, y=180)

    Label(frame1, text='Account number',fg='white',bg='black', font=('Yu Gothic', 15, 'bold')).place(x=510, y=300)
    e1 = Entry(frame1, bd=5, width=30).place(x=700, y=300)

    Label(frame1, text='Password',fg='white',bg='black', font=('Yu Gothic', 15, 'bold')).place(x=510, y=360)
    e2 = Entry(frame1, bd=5, width=30, show='*').place(x=700, y=360)

    b1 = Button(frame1, text='LOGIN', width=14, bd=6, bg='gray', font=('arial', 10, 'bold'),command=lambda: login(frame1, root))
    b1.place(x=505, y=450)

    b2 = Button(frame1, text='SIGNUP', width=14, bd=6, bg='gray', font=('arial', 10, 'bold'),command=lambda :signup(frame1,root))
    b2.place(x=655, y=450)

    b3 = Button(frame1, text='FORGOT PASSWORD', width=16, bd=6, bg='gray', font=('arial', 10, 'bold'),command=lambda:forget_password(frame1,root))
    b3.place(x=800, y=450)
...
def login(frame1,root):
    ...
    button2 = Button(frame2, text='DEBIT', width='20',bd=8,bg='black',fg='white', font=('arial', 15, 'bold'), command=lambda: debit(frame2, root))
    button2.place(x=350, y=200)
    button3 = Button(frame2, text='CREDIT', width='20',bd=8, bg='black',fg='white',font=('arial', 15, 'bold'), command=lambda: credit(frame2, root))
    button3.place(x=850, y=200)
    button4 = Button(frame2, text='CHECK BALANCE', bg='black',fg='white',width='20',bd=8, font=('arial', 15, 'bold'), command=lambda: check_balance(frame2, root))
    button4.place(x=350, y=420)
    button5 = Button(frame2, text='EXIT', width='20',bd=8,bg='black',fg='white', font=('arial', 15, 'bold'), command=lambda:iBacklogin(frame2))
    button5.place(x=850, y=420)
...
def signup(frame1,root):
    ...
    l1 = Label(frame3, text="Name : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=250)
    l2 = Label(frame3, text="E-Mail ID : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=300)
    l3 = Label(frame3, text="Phone No. : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=350)
    l4 = Label(frame3, text="Initial Balance : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=400)
    l5 = Label(frame3, text="Address : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=450)
    #l6 = Label(frame3, text="Password : ", font=('arial', 14, 'bold'), bg='black', fg='white').place(x=500, y=500)
    e1 = Entry(frame3, bd=5, width=30).place(x=650, y=250)
    e2 = Entry(frame3,bd=5, width=30).place(x=650, y=300)
    e3 = Entry(frame3, bd=5, width=30).place(x=650, y=350)
    e4 = Entry(frame3, bd=5, width=30).place(x=650, y=400)
    e5 = Entry(frame3, bd=5, width=30).place(x=650, y=450)
    b1 = Button(frame3, text='SIGNUP', bd=8, bg='black', fg='white', font=('arial', 10, 'bold'))
    b1.place(x=500, y=520)
    b2 = Button(frame3, text=' BACK ', bd=8, bg='black', fg='white', font=('arial', 10, 'bold'), command=lambda: iBackSignup(frame3))
    b2.place(x=780, y=520)

    #e6 = Entry(frame3,bd=5, width=30).place(x=650, y=500)
    #acc = list(data.keys())[-1] + 1
    #b1 = Button(frame3, text="Sign Up", bg='grey', font=("licada", 13, 'bold'),
                #command=lambda: signup(var_name, var_email, var_phno, var_bal, var_address, var_password, acc, frame5,
                 #                      root))
    #b1.place(x=760, y=620)
    #b8 = Button(frame3, text="Back", bg='lightgray', font=("licada", 13, 'bold'), command=lambda: iBackSup(frame5))
    #b8.place(x=770, y=710)

    frame3.mainloop()


def debit(frame2,root):
    frame2.destroy()
    frame4=Frame(root,width=1366,height=768,bg='blue')
    frame4.place(x=0,y=0)
    img = ImageTk.PhotoImage(Image.open('C:\\Users\\Akshay\\PycharmProjects\\Project1\\money.jpg'))
    ...
    Label(frame4, text='Enter Debeting Amount :', fg='white', bg='black', font=('arial', 15, 'bold')).place(x=520, y=250)
    e1 = Entry(frame4, bd=3, width=30).place(x=780, y=250)

    b8 = Button(frame4, text="Proceed" ,bd=8, bg='black', fg='white', font=('arial', 10, 'bold'))
    b8.place(x=600, y=330)
    b9 = Button(frame4, text="Back",  bd=8, bg='black', fg='white', font=('arial', 10, 'bold'),command=lambda:iBackDebit(frame4))
    b9.place(x=800, y=330)
    frame4.mainloop()

def credit(frame2,root):
    frame2.destroy()
    frame5=Frame(root,width=1366,height=768,bg='red')
    frame5.place(x=0,y=0)
    img = ImageTk.PhotoImage(Image.open('C:\\Users\\Akshay\\PycharmProjects\\Project1\\saving.jpg'))
    ...
    Label(frame5, text='Enter Credeting Amount :', fg='white', bg='black', font=('arial', 15, 'bold')).place(x=520,y=250)
    e1 = Entry(frame5, bd=3, width=30).place(x=780, y=250)

    b8 = Button(frame5, text="Proceed", bd=8, bg='black', fg='white', font=('arial', 10, 'bold'))
    b8.place(x=600, y=330)
    b9 = Button(frame5, text="Back", bd=8, bg='black', fg='white', font=('arial', 10, 'bold'),command=lambda:iBackCredit(frame5))
    b9.place(x=800, y=330)
    frame5.mainloop()


def check_balance(frame2,root):
    frame2.destroy()
    frame6=Frame(root,width=1366,height=768,bg='green')
    frame6.place(x=0,y=0)
    img = ImageTk.PhotoImage(Image.open('C:\\Users\\Akshay\\PycharmProjects\\Project1\\counting.jpg'))
    ...
    Label(frame6, text='Enter Account number :', fg='white', bg='black', font=('arial', 15, 'bold')).place(x=400, y=250)
    e1 = Entry(frame6, bd=3, width=30).place(x=700, y=250)
    b = Button(frame6, text="Back", bd=8, bg='black', fg='white', font=('arial', 10, 'bold'),command=lambda: iBackCheck(frame6))
    b.place(x=600, y=300)
...
def forget_password(frame1,root):
    ...
    Label(frame7, text='Enter Account number :', fg='white', bg='black', font=('arial', 15, 'bold')).place(x=400,y=250)
    e1 = Entry(frame7, bd=3, width=30).place(x=700, y=250)

    Label(frame7, text='Enter Received OTP :', fg='white', bg='black', font=('arial', 15, 'bold')).place(x=400, y=300)
    e1 = Entry(frame7, bd=3, width=30).place(x=700, y=300)

    b8 = Button(frame7, text="Proceed", bd=8, bg='black', fg='white', font=('arial', 10, 'bold'))
    b8.place(x=500, y=400)
    b9 = Button(frame7, text="Back", bd=8, bg='black', fg='white', font=('arial', 10, 'bold'),command=lambda :iBackpass(frame7))
    b9.place(x=800, y=400)
...
def iBacklogin(frame2):
    qBack = tkinter.messagebox.askquestion("Back system", "Do you want to go back to home?")
    if qBack:
        frame2.destroy()
        return home()
...
def iBackDebit(frame4):
    qBack = tkinter.messagebox.askquestion("Back system", "Do you want to go back to home?")
    if qBack:
        frame4.destroy()
        return login(frame4,root)

def iBackCredit(frame5):
    qBack = tkinter.messagebox.askquestion("Back system", "Do you want to go back to home?")
    if qBack:
        frame5.destroy()
        return login(frame5,root)
def iBackCheck(frame6):
    qBack = tkinter.messagebox.askquestion("Back system", "Do you want to go back to home?")
    if qBack:
        frame6.destroy()
        return login(frame6,root)
